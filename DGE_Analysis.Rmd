...
```{r scatter_plots, dev='png', fig.show='hide'}
...
```{r hist_plots, dev='png', fig.show='hide'}
...
```{r s2s_heatmap_plot, dev='png', fig.show='hide'}
...
```{r pca_plot, dev='png', fig.show='hide', message=FALSE, warning=FALSE}
# PCA Plot
...
```{r dispersion_plot, dev='png', fig.show='hide', }
# Dispersion Plot
...
```{r ma_plot, dev='png', fig.show='hide', }
# MA Plot
DESeq2::plotMA(
  res05, 
...
```{r volcano_plot, dev='png', fig.show='hide', }
# Volcano Plot
...
```{r upreg_heatmap, dev='png', fig.show='hide', }
...
```{r downreg_heatmap, dev='png', fig.show='hide', }
